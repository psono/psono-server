...
class EncryptJSONRenderer(JSONRenderer):
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        ...
        """
        decrypted_data = super(EncryptJSONRenderer, self).render(
        ...
        decrypted_data_json = super(EncryptJSONRenderer, self).render(
            encrypted_data, accepted_media_type, renderer_context
        )
