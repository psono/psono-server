...
from ..app_settings import ReadSecretHistorySerializer
...
class SecretHistoryView(GenericAPIView):
    ...
    def get(self, request, secret_id, *args, **kwargs):
        ...
        serializer = ReadSecretHistorySerializer(
        ...
        history_items = Secret_History.objects.filter(secret_id=secret.id).values(
            "id", "create_date", "user__username"
        )
