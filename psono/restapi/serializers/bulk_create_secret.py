...
class BulkCreateSecretSingleSerializer(serializers.Serializer):
    ...
    callback_url = serializers.CharField(
        required=False, max_length=2048, default="", allow_blank=True
    )
    callback_user = serializers.CharField(
        required=False, max_length=128, default="", allow_blank=True
    )
...
class BulkCreateSecretSerializer(serializers.Serializer):
    secrets = serializers.ListField(
        child=BulkCreateSecretSingleSerializer(), min_length=1
    )
