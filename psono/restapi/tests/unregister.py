...
class UnegistrationTests(APITestCaseExtended):
    ...
    def test_post_authentication_unregister_user_without_email(self):
        ...
        data = {"username": test_username_no_email}
    ...
    def test_post_authentication_unregister_email_and_username(self):
        ...
        self.assertEqual(
            ...
            ["EITHER_USERNAME_OR_EMAIL_NEED_TO_BE_DEFINED_NOT_BOTH"],
        )
    ...
    def test_post_authentication_unregister_without_email_and_username(self):
        ...
        self.assertEqual(
            response.data.get("non_field_errors"),
            ["EITHER_USERNAME_OR_EMAIL_NEED_TO_BE_DEFINED"],
        )
    ...
    def test_put_authentication_unregister_invalid_unregistration_code(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(
            response.data.get("non_field_errors"), ["UNREGISTRATION_CODE_INCORRECT"]
        )
