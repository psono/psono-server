...
class ReadFileRepositryTest(APITestCaseExtended):
    ...
    def test_read_all_success(self):
        ...
        self.assertEqual(
            file_repository.get("accepted"), self.file_repository_right.accepted
        )
        self.assertEqual(
            file_repository.get("file_repository_right_id"),
            str(self.file_repository_right.id),
        )
    ...
    def test_read_single_success(self):
        ...
        url = reverse(
            "file_repository",
            kwargs={"file_repository_id": str(self.file_repository.id)},
        )
    ...
    def test_read_single_that_does_not_exist(self):
        ...
        url = reverse(
            "file_repository",
            kwargs={"file_repository_id": "1fd3401a-cd3d-4904-b82b-c86befe45645"},
        )
...
class CreateFileRepositryTest(APITestCaseExtended):
    ...
    @override_settings(
        ALLOWED_OTHER_S3_ENDPOINT_URL_PREFIX=["https://allowed.s3.url.com/with-path"]
    )
