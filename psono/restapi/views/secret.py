...
class SecretView(GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        serializer = ReadSecretSerializer(
    ...
    def put(self, request, *args, **kwargs):
        ...
        try:
            callback_pass = encrypt_with_db_secret(
            ...
            return Response(
                {"error": "DuplicateNonce", "message": "Don't use a nonce twice"},
                status=status.HTTP_400_BAD_REQUEST,
            )

        if not create_secret_link(
    ...
    def post(self, request, *args, **kwargs):
        ...
        serializer = UpdateSecretSerializer(
            data=request.data, context=self.get_serializer_context()
        )
