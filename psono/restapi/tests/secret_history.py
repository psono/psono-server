...
class ReadSecretHistory(APITestCaseExtended):
    """
    Test to read the history of a secret (GET)
    """
    ...
    def setUp(self):
        ...
        self.test_private_key_nonce2 = (
            "4298a9ab3d8d5d8643dfd4445adc30301b565ab650497fb9"
        )
    ...
    def test_put(self):
        ...
        url = reverse(
            "secret_history", kwargs={"secret_id": str(self.test_secret_obj.id)}
        )
    ...
    def test_read_history_of_secret_success(self):
        ...
        self.assertTrue("history" in response.data)

        history = response.data["history"]
        self.assertEqual(len(history), 1)

    def test_read_history_of_secret_failure_secret_id_not_exist(self):
        """
        Tests to read the history of a secret where the secret does not exist
        """

        url = reverse(
            "secret_history",
            kwargs={"secret_id": "7dcbbf10-d45b-431c-ac5b-da0d6da2c303"},
        )
    ...
    def test_read_history_of_secret_failure_no_permission(self):
        """
        Tests to read the history of a secret where the user has no permission at all
        """
    ...
    def test_read_history_of_secret_failure_no_read_permission(self):
        """
        Tests to read the history of a secret where the user has no read permission
        """
