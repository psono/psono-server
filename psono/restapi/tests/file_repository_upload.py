...
def gcs_construct_signed_upload_url_side_effect(bucket, json_key, hash_checksum):
    return "https://example.com/whatever", {'param1': 'one', 'param2': 'one',}

class FileRepositryUploadTest(APITestCaseExtended):
    """
    Test to file repository uploads
    """
    ...
    def setUp(self):
        ...
        self.file_repository = models.File_Repository.objects.create(
            ...
            data=encrypt_with_db_secret(json.dumps({
                'gcp_cloud_storage_bucket': 'psono-file-upload',
    ...
    def test_get(self):
        """
        Tests GET on file repository upload
        """

        url = reverse('file_repository_upload')
    ...
    def test_get_unauthenticated(self):
        """
        Tests GET on file repository upload unauthenticated
        """
    ...
    def test_post(self):
        """
        Tests POST on file repository upload
        """
    ...
    def test_post_unauthenticated(self):
        """
        Tests POST on file repository upload unauthentiated
        """
    ...
    def test_delete(self):
        """
        Tests DELETE on file repository upload
        """
    ...
    def test_delete_unauthenticated(self):
        """
        Tests DELETE on file repository upload unauthentiated
        """
    ...
    @patch('restapi.views.file_repository_upload.gcs_construct_signed_upload_url', side_effect=gcs_construct_signed_upload_url_side_effect)
    def test_success(self, fake_gcs_construct_signed_upload_url):
        """
        Tests a file repository upload successfully
        """
        ...
        self.assertEqual(response.data, {'url': 'https://example.com/whatever?param1=one&param2=one', 'fields': []})
    ...
    @patch('restapi.views.file_repository_upload.gcs_construct_signed_upload_url', side_effect=gcs_construct_signed_upload_url_side_effect)
    def test_chunk_count_exceeded(self, fake_gcs_construct_signed_upload_url):
        """
        Tests a file repository upload with a file transfer that has already been completed by chunk count
        """
    ...
    @patch('restapi.views.file_repository_upload.gcs_construct_signed_upload_url', side_effect=gcs_construct_signed_upload_url_side_effect)
    def test_chunk_size_exceeded(self, fake_gcs_construct_signed_upload_url):
        """
        Tests a file repository upload with a file transfer that has already been completed by file size
        """
    ...
    def test_put_unauthenticated(self):
        """
        Tests a file repository upload unauthenticated
        """
