...
class UserRightsDecline(APITestCaseExtended):
    ...
    def test_decline_share_right(self):
        ...
        initial_data = {"share_right_id": str(self.test_share_right1_obj.id)}
        ...
        saved_user_share_right = models.User_Share_Right.objects.get(
            pk=str(self.test_share_right1_obj.id)
        )

        self.assertEqual(saved_user_share_right.title, "", "Title should be empty")
        self.assertEqual(
            saved_user_share_right.title_nonce, "", "Title nonce should be empty"
        )
        self.assertEqual(
            saved_user_share_right.accepted, False, "Accepted flag should be false"
        )
        self.assertEqual(saved_user_share_right.key, "", "Key should be empty")
        self.assertEqual(
            saved_user_share_right.key_nonce, "", "Key nonce should be empty"
        )
        self.assertEqual(
            saved_user_share_right.key_type, "", "Key type should be empty"
        )
    ...
    def test_decline_not_existent_share_right(self):
        ...
        initial_data = {"share_right_id": "c705baca-ea0f-4848-b16e-e95fe80652f2"}
