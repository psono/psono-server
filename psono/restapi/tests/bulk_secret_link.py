...
class UserBulkDeleteSecretLinkTest(APITestCaseExtended):
    """
    ...
    def test_delete_success(self):
        ...
        url = reverse("bulk_secret_link")

        data = {"link_ids": [self.link_id]}
    ...
    def test_delete_with_not_existing_link_id(self):
        ...
        data = {"link_ids": ["cafb9645-7494-4665-bfb6-4cb416efe69d"]}
...
class UserBulkMoveSecretLinkTest(APITestCaseExtended):
    """
    ...
    def test_move_failure_link_id_does_not_exist(self):
        ...
        data = {
            "link_ids": ["d5331d29-1a33-455e-8d9d-6ad9ea3c0a0c"],
            "new_parent_share_id": self.test_share2_obj.id,
        }
