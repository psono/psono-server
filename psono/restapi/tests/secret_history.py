...
class ReadSecretHistory(APITestCaseExtended):
    ...
    def test_put(self):
        ...
        url = reverse('secret_history', kwargs={'secret_id': str(self.test_secret_obj.id)})
    ...
    def test_read_history_of_secret_failure_secret_id_not_exist(self):
        ...
        url = reverse('secret_history', kwargs={'secret_id': '7dcbbf10-d45b-431c-ac5b-da0d6da2c303'})
