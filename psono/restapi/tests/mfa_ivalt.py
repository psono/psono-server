...
class IvaltVerifyTests(APITestCaseExtended):
    def setUp(self):
        ...
        self.test_authkey = self.test_authkey = (
    ...
    def test_post_authentication_ivalt_verify_invalid_token(self):
        ...
        data = {"token": "12345", "rquest_type": "notification"}
    ...
    def mock_verify_notification_success(
        self, url=None, json=None, headers=None, timeout=None
    ):
        mock_response = Mock()
    ...
    def test_authentication_ivalt_verify_notification_sent_success(self):
        ...
        data = {"token": self.token, "request_type": "notification"}
    ...
    def test_authentication_ivalt_verify_notification_sent_invalid_request_type(self):
        ...
        data = {"token": self.token, "request_type": "other"}
        ...
        self.assertEqual(
            response.data.get("non_field_errors")[0], "INVALID_VALUE_FOR_REQUEST_TYPE"
        )

    def mock_verify_verification_success(
        self, url=None, json=None, headers=None, timeout=None
    ):
        mock_response = Mock()
        mock_response.status_code = 200
    ...
    def mock_verify_verification_pending(
        self, url=None, json=None, headers=None, timeout=None
    ):
        mock_response = Mock()
        ...
        mock_response.json.return_value = {
            "error": {
                ...
                "title": "Not Found",
                "status": 404,
                "detail": "The mobile number provided (+910123456789) was not found.",
            }
        }
        return mock_response

    def mock_verify_verification_invalid_time_window(
        self, url=None, json=None, headers=None, timeout=None
    ):
        mock_response = Mock()
        ...
        mock_response.json.return_value = {
            "error": {
                ...
                "status": 403,
                "detail": "You are not within the timezone.",
            }
        }
        return mock_response

    def mock_verify_verification_invalid_geo_fance(
        self, url=None, json=None, headers=None, timeout=None
    ):
        mock_response = Mock()
        mock_response.status_code = 403
        mock_response.json.return_value = {
            "error": {
                ...
                "title": "Invalid details",
                "status": 403,
                "detail": "You are not within the geofencing location.",
            }
        }
        return mock_response
    ...
    def test_authentication_ivalt_verify_verification_success(self):
        ...
        data = {"token": self.token, "request_type": "verification"}
    ...
    @patch(
        "restapi.utils.ivalt.requests.post",
        mock_verify_verification_invalid_time_window,
    )
    ...
    @patch(
        "restapi.utils.ivalt.requests.post", mock_verify_verification_invalid_geo_fance
    )
...
class IvaltTests(APITestCaseExtended):
    ...
    def mock_verify_verification_invalid_geo_fance(
        self, url=None, json=None, headers=None
    ):
        mock_response = Mock()
        mock_response.status_code = 403
        mock_response.json.return_value = {
    ...
    def test_post_user_ivalt_not_exist(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(
            response.data.get("non_field_errors")[0], "NO_PERMISSION_OR_NOT_EXIST"
        )
    ...
    def test_delete_user_ivalt(self):
        ...
        self.assertEqual(response.data, {"ivalt": []})
    ...
    def test_delete_user_ivalt_ivalt_id_not_exist(self):
        ...
        data = {"ivalt_id": "7e866c32-3e4d-4421-8a7d-3ac62f980fd3"}
