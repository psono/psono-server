...
class UserShareRightsWithInheritedRightTest(APITestCaseExtended):
    ...
    def test_list_share_right_with_inherited_rights(self):
        ...
        # and now lets define inherited rights
        self.test_share_inherited_right1_obj = models.User_Share_Right_Inherit.objects.create(
            share_id=self.test_share2_obj.id,
            share_right_id=self.test_share_right1_obj.id
        )
    ...
    def test_delete_share_right_with_inherited_grant_rights(self):
        ...
        self.test_share_inherited_right1_obj = models.User_Share_Right_Inherit.objects.create(
            share_id=self.test_share1_obj.id,
            share_right_id=self.test_share_right2_obj.id
        )
...
class UserInheritedShareRightsWithRightTest(APITestCaseExtended):
    ...
    def test_delete_inherited_share_right_with_grant_right(self):
        ...
        self.assertEqual(models.User_Share_Right_Inherit.objects
                         .filter(share_id=self.test_share2_obj.id,share_right_id=self.test_share_right2_obj.id)
                         .count(), 0, 'Share right with this share_id and share_right_id should have been deleted')
...
class UserInheritedShareRightsWithInheritedRightTest(APITestCaseExtended):
    ...
    def test_grant_inherited_share_right_with_grant_right(self):
        ...
        # and now lets define some inherited rights for user1 on share2
        # user1 share2 r-g
        self.test_share_inherited_right1_obj = models.User_Share_Right_Inherit.objects.create(
            share_id=self.test_share2_obj.id,
            share_right_id=self.test_share_right1_obj.id
