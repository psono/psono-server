...
class TestUtils(TestCase):
    def test_authenticate_with_no_authkey(self):
        ...
        """
        self.assertEqual(
            authenticate("asdf", False, False), (False, "AUTHKEY_NOT_PROVIDED")
        )
    ...
    def test_authenticate_with_no_username_nor_user_object(self):
        ...
        """
        self.assertEqual(
            authenticate(False, False, "asdf"), (False, "USER_NOT_PROVIDED")
        )
    ...
    @patch(
        "restapi.utils.yubikey.settings",
        YUBIKEY_CLIENT_ID="123",
        YUBIKEY_SECRET_KEY="T3VoIHlvdSBmb3VuZCBtZT8=",
        YUBICO_API_URLS=DEFAULT_YUBICO_API_URLS,
    )
    ...
    def test_yubikey_authenticate_secret_key_none_success(self):
        self.assertEqual(
            yubikey_get_yubikey_id("iuhsrgknjbfjbfdkljbfdjiufiojfd"), "iuhsrgknjbfj"
        )
...
class TestVariousUtils(TestCase):
    ...
    def test_get_datastore_get_single_datastore(self):
        self.assertEqual(
            get_datastore(datastore_id=self.test_datastore1_obj.id),
            self.test_datastore1_obj,
        )
    ...
    def test_decrypt_secret(self):
        ...
        decrypted_secret = decrypt_secret(
            nacl.encoding.HexEncoder.decode(
                b"dc7173d3e66cfda6057f16c752953aa91c452eb8df042b7a"
            ),
            nacl.encoding.HexEncoder.decode(
                b"f09293db1a4d875c7cfb939e2e83c2c0c9455de898e9b745"
            ),
            "myPassword",
            "userSauce".encode(),
            hashing_params["u"],
    ...
    def test_is_allowed_url_successful_with_subpath(self):
        ...
        self.assertTrue(
            is_allowed_url("https://test.me/path/here", ["https://test.me/path"])
        )
    ...
    def test_is_allowed_url_scheme_downgrades(self):
        ...
        self.assertFalse(
            is_allowed_url("https://test.me/path/here", ["http://test.me/path/here"])
        )
    ...
    def test_is_allowed_url_domain_changes(self):
        ...
        self.assertFalse(
            is_allowed_url("https://test.me.evil.org", ["https://test.me"])
        )
    ...
    def test_is_allowed_url_path_traversal(self):
        ...
        self.assertFalse(
            is_allowed_url(
                "https://test.me/allowed", ["https://test.me/allowed/../protected"]
            )
        )

    def test_is_allowed_url_path_appending(self):
        """
        Tests that a path appending is not working
        """

        self.assertFalse(
            is_allowed_url(
                "https://test.me/allowed-evil-escape", ["https://test.me/allowed"]
            )
        )

    def test_is_allowed_url_path_with_subpath(self):
        """
        Tests that a path appending is working for real subpaths
        """

        self.assertTrue(
            is_allowed_url("https://test.me/path/allowed", ["https://test.me/path"])
        )
...
class TestCalculateShareRightsOnShare(TestCase):
    def setUp(self):
        ...
        self.share1 = models.Share.objects.create(
            user_id=self.user1.id, data=b"my-data", data_nonce="12345"
        )
        self.share2 = models.Share.objects.create(
            user_id=self.user2.id, data=b"my-data", data_nonce="12345"
        )
