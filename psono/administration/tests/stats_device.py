...
class StatDeviceTests(APITestCaseExtended):
    def setUp(self):
    ...
    def test_read_stats_device(self):
        """
        Tests GET method on stats_device
        """

        url = reverse('stats_device')
        ...
        self.assertTrue('linux' in response.data)
        self.assertTrue('windows' in response.data)
        self.assertTrue('mac' in response.data)
        self.assertTrue('android' in response.data)
        self.assertTrue('iphone' in response.data)


    def test_create_stats_device(self):
        """
        Tests PUT method on stats_device
        """
    ...
    def test_update_stats_device(self):
        """
        Tests POST method on stats_device
        """
    ...
    def test_delete_stats_device(self):
        """
        Tests DELETE method on stats_device
        """
