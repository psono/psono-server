...
class DuoVerifyTests(APITestCaseExtended):
    ...
    def mock_auth_status_msg(
        ...
        return {"result": "deny", "status_msg": "Deny it!"}
    ...
    def mock_auth_error(
        ...
        return {"result": "deny", "error": "Funny error"}
    ...
    def test_post_authentication_duo_verify_success_with_passcode(self):
        ...
        data = {"token": self.token, "duo_token": "123456"}
    ...
    def test_post_authentication_duo_verify_invalid_token(self):
        ...
        data = {"token": "12345", "duo_token": "123456"}
...
class DuoTests(APITestCaseExtended):
    ...
    def test_get_user_duo(self):
        ...
        self.assertEqual(
            response.data,
            {"duos": [{"id": duo.id, "active": duo.active, "title": "My Sweet Title"}]},
        )
    ...
    def mock_auth_status_msg(
        ...
        return {"status_msg": "Some Status Error Message"}

    def mock_auth_undefined_error(
        self,
        username=None,
        factor=None,
        device=None,
    ...
    def test_delete_user_duo(self):
        ...
        self.assertEqual(response.data, {"duos": []})
    ...
    def test_delete_user_duo_duo_id_not_exist(self):
        ...
        data = {"duo_id": "7e866c32-3e4d-4421-8a7d-3ac62f980fd3"}
