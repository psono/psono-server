...
class UserRightsAccept(APITestCaseExtended):
    ...
    def test_accept_share_right(self):
        """
        Tests to accept a share right
        """
        ...
        # lets try to create an inherited share right for share2
        url = reverse('share_right_accept', kwargs={'uuid': str(self.test_share_right1_obj.id)})
    ...
    def test_accept_not_existent_share_right(self):
        """
