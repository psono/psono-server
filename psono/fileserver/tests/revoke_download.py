...
class RevokeDownloadTests(APITestCaseExtended):
    ...
    def test_successful(self):
        ...
        ticket_encrypted = encrypt_symmetric(
            self.file_transfer.secret_key, json.dumps(ticket_decrypted).encode()
        )
        ...
        self.assertEqual(
            self.file_transfer.size_transferred - chunk_size,
            refreshed_file_transfer.size_transferred,
        )
        self.assertEqual(
            self.file_transfer.chunk_count_transferred - 1,
