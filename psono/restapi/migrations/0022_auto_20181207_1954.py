    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_private_key",
                    models.CharField(max_length=256, verbose_name="user private key"),
                ),
                (
                    ...
                    models.CharField(
                        max_length=64,
                        unique=True,
                        verbose_name="user private key nonce",
                    ),
                ),
                (
                    "user_secret_key",
                    models.CharField(max_length=256, verbose_name="user secret key"),
                ),
                (
                    "user_secret_key_nonce",
                    models.CharField(
                        max_length=64, unique=True, verbose_name="user secret key nonce"
                    ),
                ),
                (
                    "verify_key",
                    models.CharField(max_length=64, verbose_name="verify key"),
                ),
                (
                    "read",
                    models.BooleanField(
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Restrict to specific secrets",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="Allow Insecure Access",
                    ),
                ),
                (
                    "active",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title_nonce",
                    models.CharField(max_length=64, verbose_name="title nonce"),
                ),
                (
                    "api_key",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="api_key_secrets",
                        to="restapi.API_Key",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                default="", max_length=128, verbose_name="Callback Password"
            ),
        ),
        migrations.AddField(
            model_name="secret",
            name="callback_url",
            field=models.CharField(
                default="", max_length=2048, verbose_name="Callback URL"
            ),
        ),
        migrations.AddField(
            model_name="secret",
            name="callback_user",
            field=models.CharField(
                default="", max_length=128, verbose_name="Callback User"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=True, help_text="Read permissions", verbose_name="Read"
            ),
        ),
        migrations.AddField(
            model_name="token",
            name="write",
            field=models.BooleanField(
                default=True, help_text="Write permissions", verbose_name="Write"
            ),
        ),
