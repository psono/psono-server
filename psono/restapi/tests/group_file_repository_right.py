...
class CreateGroupFileRepositryRightTest(APITestCaseExtended):
    """
    ...
    def test_create_with_group_already_having_a_right(self):
        """
        Tests to create a file repository right for a group that already has a right
        """
