...
class ClaimDeviceCodeSerializer(serializers.Serializer):
    ...
    server_public_key = serializers.CharField(
        read_only=True,
        max_length=128,
        help_text="Hex-encoded public key generated by the server.",
    )
    ...
    encrypted_credentials = serializers.SerializerMethodField(
        read_only=True, help_text="Hex-encoded encrypted credentials."
    )
