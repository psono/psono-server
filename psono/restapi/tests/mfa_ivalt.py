...
class IvaltVerifyTests(APITestCaseExtended):
    ...
    def mock_verify_notification_success(self, url=None, json=None, headers=None):
        mock_response = Mock()
    ...
    def test_authentication_ivalt_verify_notification_sent_invalid_request_type(self):
        ...
        self.assertEqual(response.data.get('non_field_errors'), 'INAVLID_VALUE_FOR_REQUEST_TYPE')

    def mock_verify_verification_success(self, url=None, json=None, headers=None):
        mock_response = Mock()
    ...
    def mock_verify_verification_pending(self, url=None, json=None, headers=None):
        mock_response = Mock()
    ...
    def mock_verify_verification_invalid_time_window(self, url=None, json=None, headers=None):
        mock_response = Mock()
...
class IvaltTests(APITestCaseExtended):
    ...
    def test_post_user_ivalt_not_exist(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response.data.get('non_field_errors'), 'NO_PERMISSION_OR_NOT_EXIST')
