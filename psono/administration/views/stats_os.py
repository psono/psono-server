from administration.serializers.stats_os_read import StatsOsReadSerializer
...
class StatsOsView(GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        serializer = StatsOsReadSerializer(
        ...
        for operation_system in operations_systems:
            if "windows" in operation_system["device_description"].lower():
                ...
                [
                    term in operation_system["device_description"].lower()
                    for term in ["linux", "ubuntu"]
                ]
            ):
