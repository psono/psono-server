...
class EmptyShareTests(APITestCaseExtended):
    ...
    def test_list_empty_shares(self):
        ...
        self.assertEqual(
            len(response.data.get("shares", False)),
            0,
    ...
    def test_get_not_existing_share(self):
        ...
        url = reverse(
            "share", kwargs={"share_id": "3c2c0f4d-8fae-4790-b5ad-55a4ae78024a"}
        )
...
class ReadShareTests(APITestCaseExtended):
    ...
    def test_list_shares_without_credentials(self):
        ...
        self.assertNotIsInstance(
            response.data.get("shares", False), list, "We got some data even with a 401"
        )
    ...
    def test_insert_share(self):
        ...
        for store in response.data.get("shares", []):
            if str(store.get("id", "")) == new_share_id:
                self.assertFalse(found, "Found our share twice in the returned list")
                found = True
        ...
        target_store = {
            ...
            "write_date": models.Share.objects.get(
                pk=new_share_id
...
class MoreUpdateShareTests(APITestCaseExtended):
    ...
    def test_bad_formatted_uuid(self):
        ...
        initial_data = {"share_id": "3c2c0f4d"}
    ...
    def test_not_existing_share(self):
        ...
        initial_data = {"share_id": "93dd801d-e709-4e2a-b9bb-1e0ed582379c"}
    ...
    def test_no_rights_on_share(self):
        ...
        initial_data = {"share_id": self.test_share2_obj.id}
    ...
    def test_no_write_rights_on_share(self):
        ...
        initial_data = {"share_id": self.test_share3_obj.id}
    ...
    def test_write_data_to_database(self):
        ...
        self.assertEqual(
            updated_share.data, data["data"].encode(), "data was not saved proper"
        )
        self.assertEqual(
            updated_share.data_nonce,
            data["data_nonce"],
