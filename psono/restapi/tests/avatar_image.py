...
class AvatarImageTest(APITestCaseExtended):
    ...
    def test_read_successful(self):
        ...
        url = reverse(
            "avatar_image",
            kwargs={
                "avatar_id": self.avatar_image.id,
                "user_id": self.test_user_obj.id,
            },
        )
        ...
        self.assertEqual(
            base64.b64encode(response.content).decode(), self.avatar_image_data_base64
        )
    ...
    def test_read_specific_with_wrong_user_id(self):
        ...
        url = reverse(
            ...
            kwargs={
                "avatar_id": self.avatar_image.id,
                "user_id": "1bcc5b2d-3eca-496a-98b1-a86734fd0d02",
            },
        )
        ...
        self.assertEqual(
            response.data["non_field_errors"], ["NO_PERMISSION_OR_NOT_EXIST"]
        )
    ...
    def test_read_specific_with_wrong_avatar_image_id(self):
        ...
        url = reverse(
            "avatar_image",
            kwargs={
                "avatar_id": "1bcc5b2d-3eca-496a-98b1-a86734fd0d02",
                "user_id": self.test_user_obj.id,
            },
        )
