...
class MetadataDatastoreTest(APITestCaseExtended):
    """
    Test to read the metadata of a datastore
    """
    def setUp(self):
    ...
    def test_read_metadata_datastore(self):
        """
        Tests to read the metadata of a datastore successfully
        """

        url = reverse('metadata_datastore', kwargs={'datastore_id': self.test_datastore_obj.id})
        ...
        self.assertEqual(json.loads(response.content), {
            "write_date": self.test_datastore_obj.write_date.isoformat(),
            "shares": [{
                "id": str(self.test_share1_obj.id),
    ...
    def test_read_metadata_datastore_not_existing_datastore_id(self):
        """
        Tests to read the metadata of a datastore that doesn't exist
        """

        url = reverse('metadata_datastore', kwargs={'datastore_id': '1c70f736-3baa-47a5-9c38-dc0f164857ad'})
    ...
    def test_read_metadata_datastore_unauthenticated(self):
        """
        Tests to read the metadata of a datastore unauthenticated
        """
    ...
    def test_read_metadata_datastore_unauthorized(self):
        """
        Tests to read the metadata of a datastore unauthorized
        """
