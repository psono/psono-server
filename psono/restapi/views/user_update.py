...
class UserUpdate(GenericAPIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        if (
            "secret_key_nonce" in request.data
            and request.data["secret_key_nonce"] is not None
        ):
        ...
        if (
            "private_key_nonce" in request.data
            and request.data["private_key_nonce"] is not None
        ):
