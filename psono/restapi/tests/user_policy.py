...
class UserPolicyTests(APITestCaseExtended):
    """
    Tests user policies
    """
    ...
    def test_put(self):
        """
        Tests PUT on user policy
        """

        url = reverse("user_policy")
    ...
    def test_read_user_policy(self):
        """
        Tests to read the user policy
        """
