...
class GroupFileRepositoryRightView(GenericAPIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        serializer = CreateGroupFileRepositoryRightSerializer(
        ...
        return Response(
            {"group_file_repository_right_id": group_file_repository_right_id.id},
    ...
    def post(self, request, *args, **kwargs):
        ...
        serializer = UpdateGroupFileRepositoryRightSerializer(
            data=request.data, context=self.get_serializer_context()
        )
        ...
        group_file_repository_right = serializer.validated_data[
    ...
    def delete(self, request, *args, **kwargs):
        ...
        serializer = DeleteGroupFileRepositoryRightSerializer(
            data=request.data, context=self.get_serializer_context()
        )
        ...
        group_file_repository_right = serializer.validated_data.get(
            "group_file_repository_right"
        )
