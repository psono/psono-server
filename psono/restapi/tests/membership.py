...
class CreateMembershipTest(APITestCaseExtended):
    """
    Test to create a membership (PUT)
    """
    ...
    def test_create_failure_declined_membership(self):
        """
        Tests to create a membership with a declined membership
        """
    ...
    def test_create_failure_no_membership(self):
        """
        Tests to create a membership with no membership
        """
    ...
    def test_create_failure_not_yet_accepted_membership(self):
        """
        Tests to create a membership with a not yet accepted membership
        """
        ...
        data = {
            "user_id": self.test_user_obj2.id,
            "group_id": self.test_group_obj5.id,
            "secret_key": "a123",
            "secret_key_nonce": "B52032040066AE04BECBBB03286469223731B0E8A2298F26DC5F01222E63D0F5",
            "private_key": "a123",
            "private_key_nonce": "D5BD6D7FCC2E086CFC28B2B2648ECA591D9F8201608A2D173E167D5B27ECA884",
    ...
    def test_create_failure_user_id_not_exist(self):
        """
        Tests to create a membership for a user that does not exist
        """

        url = reverse("membership")

        data = {
            "user_id": "672bde21-1e7a-4243-a026-a6fdde53a39c",
            "group_id": self.test_group_obj.id,
            "secret_key": "a123",
            "secret_key_nonce": "B52032040066AE04BECBBB03286469223731B0E8A2298F26DC5F01222E63D0F5",
            "private_key": "a123",
    ...
    def test_create_failure_group_id_not_exist(self):
        """
        Tests to create a membership for a group that does not exist
        """
        ...
        data = {
            "user_id": self.test_user_obj2.id,
            "group_id": "37995629-2494-47a4-b507-4245f6db1567",
            "secret_key": "a123",
            "secret_key_nonce": "B52032040066AE04BECBBB03286469223731B0E8A2298F26DC5F01222E63D0F5",
            "private_key": "a123",
            "private_key_nonce": "D5BD6D7FCC2E086CFC28B2B2648ECA591D9F8201608A2D173E167D5B27ECA884",
    ...
    def test_create_failure_invalid_secret_key(self):
        """
        Tests to create a membership with a secret key that is no hex
        """
    ...
    def test_create_failure_invalid_secret_key_nonce(self):
        """
        Tests to create a membership with a secret key nonce that is no hex
        """
    ...
    def test_create_failure_invalid_private_key(self):
        """
        Tests to create a membership with a private key that is no hex
        """
    ...
    def test_create_failure_invalid_private_key_nonce(self):
        """
        Tests to create a membership with a private key nonce that is no hex
        """
...
class DeleteMembershipTest(APITestCaseExtended):
    """
    Test to delete a secret (DELETE)
    """
    ...
    def test_delete_success(self):
        ...
        try:
            models.User_Group_Membership.objects.get(pk=self.test_membership_obj.id)
            self.fail("This membership should be deleted")
        except models.User_Group_Membership.DoesNotExist:
            pass

    def test_delete_failure_no_membership_id_provided(self):
        """
        Tests to delete a membership without a membership id
        """
    ...
    def test_delete_failure_with_a_not_yet_accepted_membership(self):
        """
        Tests to delete a membership with a not yet accepted membership
        """
    ...
    def test_delete_failure_membership_does_not_exist(self):
        """
        Tests to delete a membership that does not exist
        """

        url = reverse("membership")

        data = {
            "membership_id": "dfde51cc-7e91-4603-b83d-f9f8f2841d1f",
        }
...
class UpdateMembershipTest(APITestCaseExtended):
    """
    Test to update a membership (POST)
    """
    ...
    def test_update_success(self):
        ...
        membership = models.User_Group_Membership.objects.get(
            pk=self.test_membership_obj.id
        )

        self.assertFalse(membership.group_admin)

    def test_update_success_to_group_admin(self):
        """
        Tests to update a membership without providing group admin rights as yes or no
        """
    ...
    def test_update_failure_with_no_membership_id(self):
        """
        Tests to update a membership without a membership id
        """
    ...
    def test_update_failure_with_no_group_admin(self):
        """
        Tests to update a membership without group admin privileges
        """
    ...
    def test_update_failure_with_declined_membership(self):
        """
        Tests to update a membership with a declined membership
        """
    ...
    def test_update_failure_with_no_membership(self):
        """
        Tests to update a membership with no membership
        """
    ...
    def test_update_failure_with_not_yet_accepted_membership(self):
        """
        Tests to update a membership with a not yet accepted membership
        """
...
class ReadMembershipTest(APITestCaseExtended):
    """
    Test to read a membership (GET)
    """
