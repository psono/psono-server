...
from ..app_settings import FileRepositoryUploadSerializer
...
class FileRepositoryUploadView(GenericAPIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        serializer = FileRepositoryUploadSerializer(
        ...
        if file_transfer.file_repository.type == "gcp_cloud_storage":
            base_url, query_params = gcs_construct_signed_upload_url(
            ...
            url = azure_blob_construct_signed_upload_url(
            ...
            url_and_fields = aws_construct_signed_upload_url(
                data["aws_s3_bucket"],
                data["aws_s3_region"],
            ...
            url_and_fields = backblaze_construct_signed_upload_url(
            ...
            url_and_fields = s3_construct_signed_upload_url(
            ...
            url_and_fields = do_construct_signed_upload_url(
                data["do_space"],
                data["do_region"],
                data["do_key"],
                data["do_secret"],
