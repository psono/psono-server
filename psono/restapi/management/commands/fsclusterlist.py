    ...
    def handle(self, *args, **options):
        ...
        for cluster in clusters:
            ...
            if cluster.links.count() == 0:
                print(
                    '    Shard: Not found for this cluster. You can create one with "fsshardcreate TITLE \'Some description\'" and then link it to this cluster with "fsshardlink '
                    + str(cluster.id)
                    + ' SHARD_ID"'
                )
