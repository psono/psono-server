...
from ..app_settings import ReadSecurityReportSerializer
...
class SecurityReportView(GenericAPIView):
            ...
            entries.append(
                {
                    ...
                    if entry.create_age is not None
                    else None,
                    "write_age": duration_string(entry.write_age)
                    if entry.write_age is not None
                    else None,
    ...
    def get(self, request, security_report_id=None, *args, **kwargs):
        ...
        serializer = ReadSecurityReportSerializer(
