...
class ReadApiKeySecretTest(APITestCaseExtended):
    ...
    def test_read_api_key_secrets_success(self):
        ...
        self.assertEqual(
            api_key_secret.get("secret_id"), self.test_api_key_secret_obj.secret_id
        )
        self.assertEqual(
            api_key_secret.get("title"), self.test_api_key_secret_obj.title
        )
        self.assertEqual(
            api_key_secret.get("title_nonce"), self.test_api_key_secret_obj.title_nonce
        )
    ...
    def test_read_api_key_secrets_failure_not_exist(self):
        ...
        url = reverse(
            "api_key_secret",
            kwargs={"api_key_id": "175a2f80-0b30-4ada-a26f-cc2e9a29384b"},
        )
