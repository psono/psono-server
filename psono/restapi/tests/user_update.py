...
class UserModificationTests(APITestCaseExtended):
    ...
    @patch(
        "restapi.serializers.user_update.settings",
        DISABLE_LAST_PASSWORDS=1,
    ...
    def test_update_user_with_old_password_block_1(self, mocked_fnct):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(
            response.data, {"non_field_errors": ["CANNOT_REUSE_OLD_PASSWORD"]}
        )
